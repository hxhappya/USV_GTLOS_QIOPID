...
class ThreeAlgorithmAnalyzer:
    ...
    def plot_heading_angle_comparison(self):
        ...
        ax.plot(time_smooth, gtlos_qiopid_enhanced, color='green', linewidth=1.5,
                label='GTLS-Q1OPID', alpha=0.95, marker='', linestyle='-')
        ...
        # 设置坐标轴标签和标题
        ax.set_xlabel('time (s)', fontsize=14, fontweight='bold', labelpad=10)
        ax.set_ylabel('艏向角 (°)', fontsize=14, fontweight='bold', labelpad=10)
        # ax.set_title('三个算法艏向角对比', fontsize=18, fontweight='bold', pad=20)
    ...
    def plot_enhanced_heading_summary(self):
        ...
        ax1.plot(time_smooth, self._enhance_smooth_data(gtlos_qiopid_smooth),
                label='GTLS-Q1OPID', linewidth=1.5, color='green', alpha=0.9, marker='', linestyle='-')
