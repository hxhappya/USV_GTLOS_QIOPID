...
if __name__ == "__main__":
    ...
    # 指定三个算法的数据文件路径
    los_data_file = "data2\los_tua_circle_simulation_data_20251011_093802.pkl"  # LOS算法数据
    gtlos_data_file = "data2\gtlos_circle_simulation_data_20251011_093627.pkl"  # GTLOS算法数据
    gtlos_qiopid_data_file = "data2\gtlos-qiopid_circle_simulation_data_20251011_093719.pkl"  # GTLOS-QIOPID算法数据
