...
if __name__ == "__main__":
   ...
   # 指定三个算法的数据文件路径
    los_data_file = "data2\los_tua_line_simulation_data_20251014_142052.pkl"  # LOS算法数据
    gtlos_data_file = "data2\gtlos_tua_line_simulation_data_20251014_141941.pkl"  # GTLOS算法数据
    gtlos_qiopid_data_file = "data2\gtlos-qiopid-tua-line_simulation_data_20251014_155510.pkl"  # GTLOS-QIOPID算法数据
    # 加载数据
